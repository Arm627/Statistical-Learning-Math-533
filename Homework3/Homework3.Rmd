...
(e) We now fit a leaner model based only on Price and USYes predictors.
    ```{r}
...
(h) To search for evidence of outlier observations in the model of part (e), we can plot the residuals of the model.
    ...
    Although we did not observe outliers, we do now see evidence of a few unusually leverage observations.  We can identify the particular observation with the largest leverage statistic.
    ```{r}
