...
\
First, suppose that we have a n X p data matrix $\mathbf X$ that consists of n training observations in a p-dimensinal space. The training observations fall into two groups, where $ y_{1}, \dot, y_{n} \in {-1,1} $ and −1 represents one class and 1 the other class. 
